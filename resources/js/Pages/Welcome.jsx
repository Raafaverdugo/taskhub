...
export default function Welcome() {
    ...
    // Estado del contador que empieza en 0
    ...
    return (
        <div className="min-h-screen bg-slate-100 flex flex-col items-center justify-center p-6">
            ...
            <div className="mt-10">
                ...
                <button
                    onClick={añadirTarea}
                    className={contador >= 10
                        ? "bg-red-500 text-white px-6 py-2 rounded-lg hover:bg-red-600 shadow-md transition active:scale-95"
                        : "bg-indigo-500 text-white px-6 py-2 rounded-lg hover:bg-indigo-600 shadow-md transition active:scale-95"
                    }
                >
